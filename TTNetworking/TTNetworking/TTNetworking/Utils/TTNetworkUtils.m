...
NSString * const TTNetworkCacheBaseFolderName = @"TTNetworkCache";
NSString * const TTNetworkCacheFileSuffix = @"cacheData";
NSString * const TTNetworkCacheInfoFileSuffix = @"cacheInfo";
NSString * const TTNetworkDownloadResumeDataInfoFileSuffix = @"resumeInfo";
...
+ (NSString *)generatePartialIdentiferWithBaseUrlStr:(NSString *)baseUrlStr requestUrlStr:(NSString *)requestUrlStr methodStr:(NSString *)methodStr{
...
+ (NSString * _Nonnull)createCacheBasePath{
    return [self createBasePathWithFolderName:TTNetworkCacheBaseFolderName];
}

+ (NSString * _Nonnull)cacheDataFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    if (requestIdentifer.length > 0) {
        NSString *cacheFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer,TTNetworkCacheFileSuffix];
...
+ (NSString * _Nonnull)cacheDataInfoFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    if (requestIdentifer.length > 0) {
        NSString *cacheInfoFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer, TTNetworkCacheInfoFileSuffix];
...
+ (NSString * _Nonnull)resumeDataInfoFilePathWithRequestIdentifer:(NSString * _Nonnull)requestIdentifer{
    NSString * dataInfoFileName = [NSString stringWithFormat:@"%@.%@", requestIdentifer, TTNetworkDownloadResumeDataInfoFileSuffix];
